      ...
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <div class="dropdown text-end">
          <a href="#" class="d-block link-dark text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false" mb-checked="1" data-tip="">
            <img id="userImg" src="/img/preload.gif" alt="mdo" width="64" height="64" class="rounded-circle"> <span id="userName">  </span>
          </a> 
          <ul class="dropdown-menu text-small" aria-labelledby="dropdownUser1">
            <li><a class="dropdown-item" href="#" mb-checked="1" data-tip="">Батышева А.М.</a></li>
            <li><a class="dropdown-item" href="#" mb-checked="1" data-tip="">Понамарёва К.С.</a></li>
