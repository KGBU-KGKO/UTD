    ...
    <div class="container mb-5">
        ...
        <div class="col-md">
          <div class="form-floating">
            <select class="form-select" id="floatingSelectGrid" aria-label="Floating label select example">
              ...
              <option value="СМЭВ">Орган государственной власти</option>
            </select>
            <label for="floatingSelectGrid">Выберите вид заявителя</label>
          </div>
        </div>
      </div>    
      <div class="row g-1 mb-3">
        <div class="col-md">
          <div class="form-floating">
            ...
            <label for="floatingInputGrid">ФИО</label>
          </div>
        </div>        
      </div>
      <div class="row g-3 mb-3">
        <div class="col-md">
          <div class="form-floating">
            <input type="email" class="form-control" id="floatingInputGrid" placeholder="name@example.com" value="">
            <label for="floatingInputGrid">Дата рождения</label>
          </div>
        </div>  
        <div class="col-md">
          <div class="form-floating">
      ...
      <div class="row g-1 mb-3">
        <div class="col-md">
          <div class="form-floating">
            <input type="email" class="form-control" id="floatingInputGrid" placeholder="name@example.com" value="">
            <label for="floatingInputGrid">Адрес места жительства</label>
          </div>
        </div> 
      </div>     
      <div class="row g-3 mb-3">
        <div class="form-check form-switch">
          <input class="form-check-input" type="checkbox" role="switch" name="agentSwitch" id="agentSwitch">
          <label class="form-check-label" for="flexSwitchCheckDefault">Представитель по доверенности</label>
        </div>                
      </div>  
      ...
      <div class="row g-3 mb-3">
        <div class="col-md">
          <div class="form-floating">
            <input type="email" class="form-control" id="floatingInputGrid" placeholder="name@example.com" value="">
            <label for="floatingInputGrid">Регистрационный номер</label>
          </div>
        </div>  
        <div class="col-md">
          <div class="form-floating">
            <input type="email" class="form-control" id="floatingInputGrid" placeholder="name@example.com" value="">
            <label for="floatingInputGrid">Дата регистрации</label>
          </div>
        </div>
        <div class="col-md">
          <div class="form-floating">
            <input type="email" class="form-control" id="floatingInputGrid" placeholder="name@example.com" value="">
            <label for="floatingInputGrid">Номер СМЭВ</label>
          </div>
        </div>                 
      </div>      
      ...
      <div class="row g-1 mb-3">
        ...
        <div class="form-floating">
          ...
          <label for="floatingTextarea2">Перечень документов</label>
        </div>   
      </div> 
      <div class="row g-2 mb-3">
        <div class="col-md mb-1">
          <button type="button" class="btn btn-primary btn-lg">Создать запрос</button>   
